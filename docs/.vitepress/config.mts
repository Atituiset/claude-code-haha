...
const zhSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '程序执行流程', link: '/in-depth/01-execution-flow' },
      { text: 'Ink TUI 渲染引擎', link: '/in-depth/02-ink-tui-engine' },
      { text: '工具系统概述', link: '/in-depth/03-tools-system' },
      { text: '多 Agent 系统概述', link: '/in-depth/04-multi-agent' },
      { text: 'MCP 服务概述', link: '/in-depth/05-mcp-service' },
      { text: '状态管理与持久化', link: '/in-depth/06-state-management' },
      { text: '命令与 Skills', link: '/in-depth/07-commands-and-skills' },
      { text: 'API 层与查询流程', link: '/in-depth/08-api-and-query' },
